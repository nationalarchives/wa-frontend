...
def get_navigation_data():
    ...
    return {
        'primary': [
            ...
            {'title': 'Collections', 'url': '/collections/', 'page': {'id': 2, 'title': 'Collections'}},
            {'title': 'Help', 'url': '/help/', 'page': {'id': 3, 'title': 'Help'}},
        ],
        'secondary': [
            {'title': 'Blog', 'url': '/blog/', 'page': {'id': 4, 'title': 'Blog'}},
            {'title': 'Contact', 'url': '/contact/', 'page': {'id': 5, 'title': 'Contact'}},
        ],
        'footer': [
            {
                'heading': 'About',
...
def inject_global_context():
    ...
    return {
        ...
        'config': {
            ...
            'GOOGLE_TAG_MANAGER_ID': current_app.config.get('GOOGLE_TAG_MANAGER_ID', ''),
